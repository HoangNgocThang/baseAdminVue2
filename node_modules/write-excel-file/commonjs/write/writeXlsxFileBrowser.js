...
var _rels = _interopRequireDefault(require("./statics/rels.js"));
...
function writeXlsxFile(data) {
  ...
  return generateXlsxFile(data, rest).then(function (blob) {
    if (fileName) {
      return _fileSaver["default"].saveAs(blob, fileName);
    }
...
function generateXlsxFile(data, _ref2) {
  ...
  zip.file('_rels/.rels', _rels["default"]);
  zip.file('[Content_Types].xml', _Content_TypesXml["default"]);
  ...
  xl.file('_rels/workbook.xml.rels', (0, _workbookXmlRels["default"])({
    sheets: sheets
  }));
  xl.file('workbook.xml', (0, _workbookXml["default"])({
    sheets: sheets,
    stickyRowsCount: stickyRowsCount,
    stickyColumnsCount: stickyColumnsCount
  }));
